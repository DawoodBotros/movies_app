class BrowseLists {
  ...
  BrowseLists.fromJson(dynamic json) {
    _page = json['page'];
    if (json['results'] != null) {
      _results = [];
      json['results'].forEach((v) {
        _results?.add(ResultsList.fromJson(v));
      });
    }
  ...
  num? _page;
  List<ResultsList>? _results;
  num? _totalPages;
  num? _totalResults;

  BrowseLists copyWith({
    num? page,
    List<ResultsList>? results,
    num? totalPages,
    num? totalResults,
  ...
  List<ResultsList>? get results => _results;
...
class ResultsList {
  ...
  ResultsList.fromJson(dynamic json) {
    _adult = json['adult'];
